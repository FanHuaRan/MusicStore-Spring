 ...
 * 
 * @see com.fhr.musicstorerest.models.Album
...
public class AlbumDAO extends HibernateDaoSupport {
	...
	public Album findById(java.lang.Integer id) {
		...
		try {
			Album instance = (Album) getHibernateTemplate().get("com.fhr.musicstorerest.models.Album", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public Album merge(Album detachedInstance) {
		...
		try {
			Album result = (Album) getHibernateTemplate().merge(detachedInstance);
