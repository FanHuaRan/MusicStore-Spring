 ...
 * 
 * @see com.fhr.musicstorerest.models.Artist
...
public class ArtistDAO extends HibernateDaoSupport {
	...
	public Artist findById(java.lang.Integer id) {
		...
		try {
			Artist instance = (Artist) getHibernateTemplate().get("com.fhr.musicstorerest.models.Artist", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public Artist merge(Artist detachedInstance) {
		...
		try {
			Artist result = (Artist) getHibernateTemplate().merge(detachedInstance);
