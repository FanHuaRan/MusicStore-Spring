 ...
 * 
 * @see com.fhr.musicstorerest.models.Orderdetail
...
public class OrderdetailDAO extends HibernateDaoSupport {
	...
	public Orderdetail findById(java.lang.Integer id) {
		...
		try {
			Orderdetail instance = (Orderdetail) getHibernateTemplate().get("com.fhr.musicstorerest.models.Orderdetail",
					id);
			return instance;
		} catch (RuntimeException re) {
	...
	public Orderdetail merge(Orderdetail detachedInstance) {
		...
		try {
			Orderdetail result = (Orderdetail) getHibernateTemplate().merge(detachedInstance);
